...
class EducationProvider {
    companion object {
        private val educationList = listOf(
            Education(id = 1, studentId = 1, name = "Computer Science", institution = "UNA", year = 2024),
            Education(id = 2, studentId = 2, name = "Mechanical Engineering", institution = "TEC", year = 2025)
        )
